...
export type SetTokenURI = ContractEventLog<{
  tokenId: string;
  tokenURI: string;
  0: string;
  1: string;
...
export interface Bumpkin extends BaseContract {
  ...
  events: {
    ...
    SetTokenURI(cb?: Callback<SetTokenURI>): EventEmitter;
    SetTokenURI(
      options?: EventOptions,
      cb?: Callback<SetTokenURI>
    ): EventEmitter;
  ...
  once(event: "SetTokenURI", cb: Callback<SetTokenURI>): void;
  once(
    event: "SetTokenURI",
    options: EventOptions,
    cb: Callback<SetTokenURI>
