...
export const EXTRA_DETAILS: Record<BumpkinItem, Details> = {
  ...
  "Goblin Armor": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Goblin Helmet": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Goblin Pants": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Goblin Sabatons": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Goblin Axe": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Nightshade Armor": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Nightshade Helmet": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Nightshade Pants": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Nightshade Sabatons": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Nightshade Sword": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Bumpkin Armor": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Bumpkin Helmet": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Bumpkin Sword": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Bumpkin Pants": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Bumpkin Sabatons": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Sunflorian Armor": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Sunflorian Sword": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Sunflorian Helmet": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Sunflorian Pants": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  "Sunflorian Sabatons": { boosts: [{ trait_type: "Tradable", value: "No" }] },
};
