...
export const EXTRA_DETAILS: Record<BumpkinItem, Details> = {
  ...
  "Goblin Sabaton": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  ...
  "Nightshade Sabaton": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  ...
  "Bumpkin Sabaton": { boosts: [{ trait_type: "Tradable", value: "No" }] },
  ...
  "Sunflorian Sabaton": { boosts: [{ trait_type: "Tradable", value: "No" }] },
};
