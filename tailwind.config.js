module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      timer:
        '"Sigmar One", cursive, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
    },
    fontSize: {
      xxs: ["0.6875rem"],
      xs: ["0.75rem"],
